const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip opcional */}
      <span className="absolute right-20 bg-gray-800 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
        Fale conosco!
      </span>
    </a>
  );
